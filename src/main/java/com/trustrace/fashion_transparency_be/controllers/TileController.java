...
import com.trustrace.fashion_transparency_be.service.TileService;
...
public class TileController {
    ...
    public ResponseEntity<ApiResponse<List<TileTableDto>>> getAllTilesTableDetails(
        ...
        Page<TileTableDto> tileTableDtos = tileService.getAllTilesTableDetails(page, size, sortBy, sortDirection, search, filterBy);
