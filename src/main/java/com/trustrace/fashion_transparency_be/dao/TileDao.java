...
public class TileDao {
    ...
    public Page<Tile> getAllTiles(int page, int size, String sortBy, String sortDirection, String search, String filterBy) {
        return tileTemplate.findAll(page, size, sortBy, sortDirection, search, filterBy);
    }
